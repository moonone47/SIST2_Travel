	...
	<form method="POST"
		...
		<fieldset>
			...
			<table class="table table-bordered">
				...
				<tr>
					<td colspan="2">• 카드번호('-'제외) <br>
					<input type="number" style="width: 300px;"></td>

				</tr>
				<tr>
					<td style="width: 120px;">• 유효기간(MMYY)<br> <input
						type="number" style="width: 120px;"></td>
					<td>• CVC번호 <br> <input type="password"
						style="width: 130px;" maxlength="3"></td>
				</tr>
				<tr>
					<td>• 비밀번호 앞2자리 <input type="password" style="width: 130px;"
						maxlength="2"></td>
			...
			<fieldset>
				<input type="submit" class="btn btn-primary" id="payment"
					value="결제하기">
				<button type="button" class="btn btn-default" id="back"
					style="float: right;" onclick="history.back()">돌아가기</button>
			</fieldset>
			<input type="hidden" name=reservationseq value="${reservationseq }" /> <input
				type="hidden" name=tourseq value="${tourseq }" />
		</div>
	</form>
		<script>
