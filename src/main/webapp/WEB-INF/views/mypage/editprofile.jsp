	...
	<form method="POST" action="/SIST2_Travel/mypage/editprofileok.do">
			<table class="table table-bordered" id="tb">
				...
				<tr>
					<th>닉네임</th>
					<td>
						<input type="text" name="nick" id="nick" class="form-control" value="${dto.nick}">
					</td>
				</tr>
				<tr>
					<th>이메일</th>
				...
				<tr>
					<th>우편번호</th>
					<td>
						<input type="number" name="zip" id="zip" class="form-control" value="${dto.zip}">
					</td>
				</tr>
				<tr>
					<th>주소</th>
				...
				<tr>
					<th>생년월일</th>
					<td>
						<input type="date" name="birthday" id="birthday" class="form-control" value="${dto.birthday}">
					</td>
				</tr>
				<tr>
					<!-- 라디오버튼 값 받아오기 -->
