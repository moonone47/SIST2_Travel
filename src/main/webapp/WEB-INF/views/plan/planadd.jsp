...
<body>
	...
	<div class="map_wrap">
		...
		<iframe id='detail' class="embed-responsive embed-responsive-16by9"
			src='' frameborder='0' scrolling='yes' style='width: 800px;'>
	...
	<div class="sortable">${dto.address_name}
		${dto.category_group_code} ${dto.category_group_name}
		${dto.category_name} ${dto.id} ${dto.phone} ${dto.place_name}
		${dto.place_url} ${dto.road_address_name} ${dto.x} ${dto.y}</div>
	...
	<script>
		...
		function searchPlaces() {
			...
			if (currCategory == 'all') {
				ps.categorySearch([ 'AD5', 'AT4', 'FD6' ], placesSearchCB, {
					useMapBounds : true
				});
			}
		...
		function displayPlaces(places) {
			...
			for (var i = 0; i < places.length; i++) {
				...
				(function(marker, address_name, category_group_code,
						category_group_name, category_name, id, phone, title,
						place_url, road_address_name, x, y) {
					...
					itemEl.onclick = function() {
						...
						places[i].category_group_name, places[i].category_name,
						places[i].id, places[i].phone, places[i].place_name,
						places[i].place_url, places[i].road_address_name,
...
>>>>>>> 3401f04992754d4f3ceb2c6745661dbac65915ce
