...
<section class="ftco-section">
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col">
                <a class="navbar-brand" href="index.html">TP<span>여행 병아리들을 위한 여행계획사이트 티피~~</span></a>
            </div>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">일정계획</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            ...
                            <a class="dropdown-item" href="<%= request.getContextPath() %>/community/freeboard/list.do">자유게시판</a>
