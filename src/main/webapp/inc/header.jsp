...
<body>
	<div>
		<div id="mainimg" style="background:url('/SIST2_Travel/asset/images/key_bg_3.jpg') no-repeat;background-size:cover;"></div>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="ftco-nav">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item active"><a href="/SIST2_Travel/index.do"
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
							...
							<li class="nav-item"><a href="/SIST2_Travel/plan/plan.do"
								class="nav-link">일정계획</a></li>
							<li class="nav-item"><a
								href="/SIST2_Travel/management/travelplan.do" class="nav-link">여행관리</a></li>
							...
							<li class="nav-item dropdown"><a
								...
								<div class="dropdown-menu" aria-labelledby="dropdown04">
									<a class="dropdown-item"
										href="/SIST2_Travel/community/question/list.do">질문게시판</a> <a
										class="dropdown-item"
										href="/SIST2_Travel/community/freeboard/list.do">자유게시판</a> <a
										class="dropdown-item"
										href="/SIST2_Travel/community/clubboard/list.do">여행소모임게시판</a>
									<a class="dropdown-item"
										href="/SIST2_Travel/community/event/list.do">이벤트게시판</a> <a
										class="dropdown-item"
										href="/SIST2_Travel/community/suggest/list.do">건의게시판</a> <a
										class="dropdown-item" href="#">여행후기게시판</a>
								</div></li>

							<li class="nav-item"><a href="/SIST2_Travel/service/list.do"
							...
							<li class="nav-item dropdown"><a
								...
								<div class="dropdown-menu" aria-labelledby="dropdown04">
									...
									<a class="dropdown-item" href="#">항공권</a> <a
										...
										href="/SIST2_Travel/tour/tour.do">투어</a>
								</div></li>
							<li class="nav-item dropdown"><a
								class="nav-link dropdown-toggle" href="#" id="dropdown04_"
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false">검색</a>
								<div class="dropdown-menu" aria-labelledby="dropdown04">
									<%-- 메뉴만 만들어 놓죠ㅎㅅㅎ  넵 ^.^--%>
									<a class="dropdown-item" href="/SIST2_Travel/search/weather.do">날씨
										검색</a> <a class="dropdown-item"
										href="/SIST2_Travel/search/keyword.do">키워드 검색</a>
								</div></li>
							...
							<li class="nav-item dropdown"><a
								...
								<div class="dropdown-menu" aria-labelledby="dropdown04">
									<a class="dropdown-item" href="/SIST2_Travel/mypage/profile.do">개인정보
										조회</a> <a class="dropdown-item"
										href="/SIST2_Travel/mypage/travelplan.do">내 여행 일정 조회</a> <a
										class="dropdown-item" href="/SIST2_Travel/mypage/basket.do">장바구니</a>
									<a class="dropdown-item" href="/SIST2_Travel/mypage/rev.do">결제
										및 예약 내역</a>
								</div></li>
							...
							<c:if test="${not empty id}">
								<li class="nav-item dropdown"><img
									src="https://www.earthtory.com/res/img/common/mobile/img_profile.png"
									style="width: 50px;"> <%--                            <a class="nav-link dropdown-toggle" href="#" id="mypage"--%>
									<%--                                                         data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">마이페이지</a>--%>
									<div class="dropdown-menu" aria-labelledby="dropdown04">
										<a class="dropdown-item"
											href="/SIST2_Travel/mypage/profile.do">개인정보 조회</a> <a
											class="dropdown-item"
											href="/SIST2_Travel/mypage/travelplan.do">내 여행 일정 조회</a> <a
											class="dropdown-item" href="/SIST2_Travel/mypage/basket.do">장바구니</a>
										<a class="dropdown-item" href="/SIST2_Travel/mypage/pay.do">결제내역</a>
										<a class="dropdown-item" href="/SIST2_Travel/mypage/rev.do">예약
											내역</a> <a class="dropdown-item"
											href="/SIST2_Travel/login/logout.do">로그아웃</a>
										<c:if test="${empty id }">
											<div class="btn-auth"
												onclick="location.href='/SIST2_Travel/login/login.do';"
												title="로그인" style="color: white; cursor: pointer;">Login
