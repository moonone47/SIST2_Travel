...
//            java.sql.SQLSyntaxErrorException: ORA-00932: inconsistent datatypes: expected DATE got NUMBER
	...
	/*
	 * tblSights SIGHTSSEQ NUMBER NAME VARCHAR2(100 BYTE) 1 EXPLAIN VARCHAR2(2000
	 * BYTE) @ 2 ADDRESS VARCHAR2(500 BYTE) 3 null IMAGE VARCHAR2(1000 BYTE) ----?
	 * 삭제 @ 4 GRADE NUMBER ----? 삭제 @ 5 WISH VARCHAR2(10 BYTE)@ 6 THEME VARCHAR2(100
	 * BYTE) ---?@ 7 SIGHTSX NUMBER 8 SIGHTSY NUMBER 9 PLANDATE DATE rdate 10 null
	 * BUDGET NUMBER -----? 삭제 @ 11 SEQ NUMBER 12 URL VARCHAR2(200 BYTE) 13 PLANSEQ
	 * NUMBER -> session 전체 일정 planseq 14 ID VARCHAR2(50 BYTE) 15
	 */
...
//        java.sql.SQLIntegrityConstraintViolationException: ORA-02290: check constraint (SIST2_TRAVEL.SYS_C008957) violated
	...
	public void addAT4(PlaceDTO dto, String tblplanseq, String memberid) {
		try {
			String sql = "insert into tblSights values(seqSights.nextval, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? , "
					+ "?, ?, ?, ?, ?)";
	...
	/*
	 * ROOMSSEQ NUMBER NAME VARCHAR2(50 BYTE) 1 EXPLAIN VARCHAR2(4000 BYTE) 2
	 * ADDRESS VARCHAR2(200 BYTE) 3 IMAGE VARCHAR2(1000 BYTE) 4 GRADE NUMBER 5 WISH
	 * VARCHAR2(10 BYTE) 6 THEME VARCHAR2(100 BYTE) 7 ROOMSX NUMBER 8 ROOMSY NUMBER
	 * 9 PLANDATE DATE 10 BUDGET NUMBER 11 SEQ NUMBER 12 URL VARCHAR2(200 BYTE) 13
	 * PLANSEQ NUMBER 14 ID VARCHAR2(50 BYTE) 15
	 */
	// AD5 숙박

	/*
	 * RESTAURANTSEQ NUMBER NAME VARCHAR2(100 BYTE) EXPLAIN VARCHAR2(2000 BYTE)
	 * ADDRESS VARCHAR2(500 BYTE) IMAGE VARCHAR2(1000 BYTE) GRADE NUMBER WISH
	 * VARCHAR2(10 BYTE) THEME VARCHAR2(500 BYTE) RESTAURANTX NUMBER RESTAURANTY
	 * NUMBER PLANDATE DATE BUDGET NUMBER SEQ NUMBER URL VARCHAR2(500 BYTE) PLANSEQ
	 * NUMBER ID VARCHAR2(50 BYTE)
	 */
